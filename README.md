...
現在の候補プールは公開用DB内の1,978組です。うち1,676組にWikidata項目、1,422組にジャンルがあり、30人未満の若者向け8組とDYGLの計9組すべてに補助候補を生成できました。若者向け8組では、行動Top 50に含まれた既知候補45件を除外し、メタデータ候補にも同じ除外表を適用しています。この段階は推薦精度の合格を意味しないため、新しい80候補を0・1・2で人手評価してから採否を決めます。
